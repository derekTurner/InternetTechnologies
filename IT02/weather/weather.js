...
var mainApp = angular.module("asafdav.ngWeather", []);
mainApp.value("apiEndpoint", "http://api.openweathermap.org/data/2.5/weather");
mainApp.value("iconEndpoint", "http://openweathermap.org/img/w/");

mainApp.service("weatherService", ["$http", "$q", "apiEndpoint", "iconEndpoint", function(a, b, c, d){
  function e(a)
 {
...
/*
mainApp.directive("cityWeather", ["weatherService", function(cityName)
{
  return {
    scope:
    {
